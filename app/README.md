...
Vite + React + TypeScript demo dApp for AttestRail. Separate from the public landing page in `frontend/`.
...
Contract addresses are read at build time from `../deployments/sepolia/addresses.json` (written by `scripts/deploy.ts`).
